...
`hi` describes itself. Its own intent lives in [`hi/`](hi/), across 10 families in 7 files, and the
feature list in [`INTENT.md`](INTENT.md) at the root is generated with the count per feature, and
