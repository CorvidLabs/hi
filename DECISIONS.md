...
and §31 corrects it. The refresh is best effort by design — the subsection below says so two
...
`hi index`, and it is now reached without being asked for. **§31 withdraws this one**: it was
...
## 31. Making a write automatic widens whatever was already wrong with it
